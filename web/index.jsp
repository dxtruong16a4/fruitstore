        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <a href="${pageContext.request.contextPath}/products" class="btn btn-success btn-lg">Shop Now</a>
                </div>
                <div class="col-lg-6">
    ...
    <div class="bg-light py-5">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <a href="${pageContext.request.contextPath}/products" class="btn btn-success btn-lg">View All Products</a>
            </div>
        </div>
    </div>
